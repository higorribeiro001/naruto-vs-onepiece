...
class Sasuke:
    def sprites(self):
        return [
            {
                'sprites_right': [
                    pygame.image.load('character_sasuke/sasuke_base/sasuke_right2.png'),
                    pygame.image.load('character_sasuke/sasuke_base/sasuke_right3.png'),
                ],
            },
            {
                'sprites_left': [
                    pygame.image.load('character_sasuke/sasuke_base/sasuke_left2.png'),
                    pygame.image.load('character_sasuke/sasuke_base/sasuke_left3.png'),
                ],
            },
            {
                'sprites_run_right': [
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_right1.png'),
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_right2.png'),
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_right3.png'),
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_right4.png'),
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_right5.png'),
                ],
            },
            {
                'sprites_run_left': [
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_left1.png'),
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_left2.png'),
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_left3.png'),
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_left4.png'),
                    pygame.image.load('character_sasuke/sasuke_run/sasuke_run_left5.png'),
                ],
            },
            {
                'sprites_jump_left': [
                    pygame.image.load('character_sasuke/sasuke_jump/sasuke_jump_left1.png'),
                    pygame.image.load('character_sasuke/sasuke_jump/sasuke_jump_left2.png'),
                    pygame.image.load('character_sasuke/sasuke_jump/sasuke_jump_left3.png')
                ],
            },
            {
                'sprites_jump_right': [
                    pygame.image.load('character_sasuke/sasuke_jump/sasuke_jump_right1.png'),
                    pygame.image.load('character_sasuke/sasuke_jump/sasuke_jump_right2.png'),
                    pygame.image.load('character_sasuke/sasuke_jump/sasuke_jump_right3.png')
                ],
            },
            {
                'sprites_punch_right': [
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_right1.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_right2.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_right3.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_right4.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_right5.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_right6.png'),
                ],
            },
            {
                'sprites_punch_left': [
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_left1.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_left2.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_left3.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_left4.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_left5.png'),
                    pygame.image.load('character_sasuke/sasuke_punch/sasuke_punch_left6.png'),
                ],
            },
            {
                'sprites_block_left': [
                    pygame.image.load('character_sasuke/sasuke_block/sasuke_block_left.png'),
                ],
            },
            {
                'sprites_block_right': [
                    pygame.image.load('character_sasuke/sasuke_block/sasuke_block_right.png'),
                ],
            },
            {
                'sprites_kick_left': [
                    pygame.image.load('character_sasuke/sasuke_kick/sasuke_kick_left1.png'),
                    pygame.image.load('character_sasuke/sasuke_kick/sasuke_kick_left2.png'),
                    pygame.image.load('character_sasuke/sasuke_kick/sasuke_kick_left3.png'),
                ],
            },
            {
                'sprites_kick_right': [
                    pygame.image.load('character_sasuke/sasuke_kick/sasuke_kick_right1.png'),
                    pygame.image.load('character_sasuke/sasuke_kick/sasuke_kick_right2.png'),
                    pygame.image.load('character_sasuke/sasuke_kick/sasuke_kick_right3.png'),
                ],
            },
            {
                'sprites_chakra_left': [
                    pygame.image.load('character_sasuke/sasuke_chakra/sasuke_chakra_left.png'),
                ],
            },
            {
                'sprites_chakra_right': [
                    pygame.image.load('character_sasuke/sasuke_chakra/sasuke_chakra_right.png'),
                ]
            },
            {
            ...
            },
            {
                'sprites_damage_right': [
                    pygame.image.load('character_sasuke/sasuke_damage/sasuke_damage_right1.png'),
                    pygame.image.load('character_sasuke/sasuke_damage/sasuke_damage_right2.png'),
                    pygame.image.load('character_sasuke/sasuke_base/sasuke_right2.png'),
                ]
            },
            {
                'sprites_damage_left': [
                    pygame.image.load('character_sasuke/sasuke_damage/sasuke_damage_left1.png'),
                    pygame.image.load('character_sasuke/sasuke_damage/sasuke_damage_left2.png'),
                    pygame.image.load('character_sasuke/sasuke_base/sasuke_left2.png'),
                ]
            },
            {
                'sprites_dead_left': [
                    pygame.image.load('character_sasuke/sasuke_dead/sasuke_dead_left1.png'),
                    pygame.image.load('character_sasuke/sasuke_dead/sasuke_dead_left2.png'),
                    pygame.image.load('character_sasuke/sasuke_dead/sasuke_dead_left3.png'),
                ]
            },
            {
                'sprites_dead_right': [
                    pygame.image.load('character_sasuke/sasuke_dead/sasuke_dead_right1.png'),
                    pygame.image.load('character_sasuke/sasuke_dead/sasuke_dead_right2.png'),
                    pygame.image.load('character_sasuke/sasuke_dead/sasuke_dead_right3.png'),
                ]
            }
        ]
