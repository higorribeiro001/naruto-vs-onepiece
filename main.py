...
def menu_screen():
    ...
    play_button = pygame.Rect(WIDTH // 2 - button_width // 2, HEIGHT // 2, button_width, button_height)
...
def battle_screen(running=True):
    ...
    def damage_p1(dif_pos_right, dif_pos_left, dif_pos_y_p1, dif_pos_y_p2, damage):
        if (-10 > dif_pos_right > -60 and dif_pos_y_p1 == dif_pos_y_p2) and keys[pygame.K_DOWN] is False:
            if p2.life > 0:
                p2.life -= damage
                p2.damage()
